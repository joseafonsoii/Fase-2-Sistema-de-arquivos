...
int fs_copy(fs_t* fs, char* srcpath, char *tgtpath) {
  ...
  /* copy-on-write: criar novo ficheiro (vazio) chamando o createfile, obter o inode do file original, e copiar a sua lista de block numbers para o inode do novo ficheiro */
